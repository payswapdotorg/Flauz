/*---------------------------------------------------------------------------------------------
 *  flauz-workspace — test/envelope.test.ts
 *
 *  Envelope lifecycle + git-diffability discipline (DL-9): bootstrap shape and
 *  idempotency, schema validation, canonical serialization (byte-exact fixtures,
 *  round-trip identity, determinism), task-id allocation, timeline recording, and
 *  atomic-write residue checks.
 *--------------------------------------------------------------------------------------------*/
